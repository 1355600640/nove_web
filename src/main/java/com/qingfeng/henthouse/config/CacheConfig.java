...
public class CacheConfig {
    private static final Integer defalutTime = 1000 * 60 * 60 * 24;
    /**
    ...
    public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory){
        ...
        RedisCacheManager redisCacheManager = RedisCacheManager.builder(redisConnectionFactory)
                .cacheDefaults(defaultCacheConfig(defalutTime))
...
//        configMap.put("qingfeng-novel-recommend",this.defaultCacheConfig(defalutTime));
        return configMap;
    }
}
